...
<div class="container">
    ...
    <div class="row">
{{--        40%--}}
                <div style="width: 40%;height: 320px; float: left;border-right: solid 1px black;">
                    <p style="padding: 2px 15px;">
                        ...
                        <b>importo in lettere:</b> <span style="padding-left: 10px;font-size: 11px;">{{ $converted ?? ''}}</span>
                        </p>
                    ...
                    <li style="margin-top:10px;margin-right: 30px;border: solid 1px red;">bollo dell'ufficio postale</li>
...
{{--                    </div>--}}
        ...
        <div style="width:60%;height: 320px;float: left;">
            <p style="padding: 2px 15px;">
{{--                <img src="../../../public/img/euro.jpeg" alt="" style="width: 30px;height: 30px;">--}}
            ...
            <p style="text-transform: uppercase;font-size: 9px;padding:0px 11px;margin-top: -10px">
                <b style="font-weight: bolder;font-size: 14px;">TD &nbsp;&nbsp;123&nbsp;&nbsp;&nbsp; </b> <b>importo in lettere:</b> <span style="padding-left: 10px;font-size: 11px;">{{ $converted ?? ''}}</span>
            </p>
...
{{--            </p>--}}
            ...
            <div style="height:auto;width: 65%;float: right;">
                <fieldset style="border: solid 1px black;padding:1px 15px;margin:18px 15px 3px;border-radius: 5px;max-height: 30px;">
            ...
            <div style="margin:-35px 0px 0px; ;padding: 5px 4px 0px;clear: both;font-weight: bold;height:20px;width: 100%;border: solid 1px red;"  >
