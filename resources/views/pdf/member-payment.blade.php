...
{{--                &nbsp;&nbsp;&nbsp;&nbsp;importo in lettere: <b style="padding-left: 10px;font-size: 11px;">{{ $converted ?? ''}}</b>--}}
{{--            </p>--}}
            <fieldset style="border: solid 1px black;padding: 1px 15px;margin:-7px 15px 3px  ;border-radius: 5px;max-height: 30px;">
            <legend style="text-transform: uppercase;font-size: 9px;width: auto;"><b style="text-transform: uppercase;border: none;">intestato a</b></legend>
...
<div >
    <div  style="width:98%;height:60px;margin-right:14px;margin-top: -1px;border-bottom: solid 1px black;border-right: solid 1px black;border-left: solid 1px black;">
