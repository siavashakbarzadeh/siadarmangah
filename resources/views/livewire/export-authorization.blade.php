<div>
<a wire:click="exportAuth" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
    ...
    @if($exportFinished)
        <div class="alert alert-success text-medium" role="alert">
            Export pronto. Scaricalo <a href="{{route('authorization_download')}}" class="alert-link">qui</a>
        </div>
    @endif
