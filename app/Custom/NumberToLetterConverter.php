...
class NumberToLetterConverter {
    ...
    private $MONEDAS = array(
        ...
        array('country' => 'Europa', 'currency' => 'EUR', 'singular' => '', 'plural' => '', 'symbol', '€'),
    ...
    private function convertNumber($number, $miMoneda = null, $type) {
        ...
        if (intval($millones) > 0) {
            if ($millones == '001') {
                ...
                $converted .= sprintf('%sMILIONI', $this->convertGroup($millones));
            }
        }
        ...
        if (intval($miles) > 0) {
            if ($miles == '001') {
                ...
                $converted .= sprintf('%sMILLE', $this->convertGroup($miles));
            }
        }
