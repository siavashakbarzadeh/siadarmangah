...
class ReportController extends Controller
{
    ...
    {
        return response()->download(storage_path(env('DOWNLOAD_URL').'export/autorizzazioni-soci.xlsx'));
    }
    public function downloadStatus()
    {
        return response()->download(storage_path(env('DOWNLOAD_URL').'export/status-soci.xlsx'));
    }
    public function downloadAccountability()
    {
        return response()->download(storage_path(env('DOWNLOAD_URL').'export/situazione-contabile-soci.xlsx'));
    }
    public function downloadStudyGroup()
    {
        return response()->download(storage_path(env('DOWNLOAD_URL').'export/gruppi-studio.xlsx'));
    }
}
